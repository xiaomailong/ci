...
void process_command()
{
	...
	if (NO_INDEX != first_button)
	{
		...
		{			
			if (IsTRUE(is_button_locked(first_button))
				|| IsTRUE(is_button_locked(second_button))
				|| IsTRUE(is_button_locked(third_button))
				|| IsTRUE(is_button_locked(fourth_button))
				|| IsTRUE(is_button_locked(fifth_button)))
			{
				if(IsTRUE(is_button_locked(first_button)))
				{
					CIHmi_SendNormalTips("按钮封锁：%s",gn_name(first_button));
				}
				if(IsTRUE(is_button_locked(second_button)))
				{
					CIHmi_SendNormalTips("按钮封锁：%s",gn_name(second_button));
				}
				if(IsTRUE(is_button_locked(third_button)))
				{
					CIHmi_SendNormalTips("按钮封锁：%s",gn_name(third_button));
				}
				if(IsTRUE(is_button_locked(fourth_button)))
				{
					CIHmi_SendNormalTips("按钮封锁：%s",gn_name(fourth_button));
				}
				if(IsTRUE(is_button_locked(fifth_button)))
				{
					CIHmi_SendNormalTips("按钮封锁：%s",gn_name(fifth_button));
				}				
				/*清除按钮记录*/
				clean_button_log();	
			}
