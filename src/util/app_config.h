...
#define MAX_BUTTONS 300				/*站场中最大按钮数量*/
#define MAX_SIGNAL_NODES 700		/*站场中最大信号节点数量*/
#define MAX_ILTS 800				/*站场中最大联锁表数量*/
...
#define MAX_SWITCH_JCBJ	(MAX_SIGNAL_NODES / 3) /*站场中最大挤岔报警数量*/
#define MAX_SPECIAL_INPUT 10		/*站场中最大特殊输入数量*/
#define MAX_BUTTON_LOCKED (MAX_BUTTONS / 8 + 1)		/*站场中最大按钮封锁数量*/
#define MAX_TRAIN_LOSS (MAX_SIGNAL_NODES / 3)		/*站场中最大区段分路不良数量*/
#define MAX_SIGNAL_SHOW_CHANGE 10		/*站场中最大信号变更显示数量*/
#define MAX_SIGNAL_DELAY_OPEN 5		/*站场中最大信号延时开放数量*/
#define MAX_SECTION_COMPOSE 2		/*站场中最大区段合并数量*/
#define MAX_HIGH_CROSS 20		/*站场中最大道口数量*/
#define MAX_CROSS_STATION 1		/*站场中最大跨场作业数量*/
...
#define MAX_CONCURRENCY_SWITCH   6                       /*最大同时转岔数量*/
#define MAX_WAIT_SWITCH (MAX_SIGNAL_NODES / 2)            /*等待转岔队列长度*/
#define MAX_SWITCH_PER_SECTION 4                         /*同一个区段中最大的道岔数*/
#define MAX_SWITCH_TIME (13000 / CI_CYCLE_MS)            /*最大转岔时间*/
#define MAX_CLEARING_SECTION (MAX_SIGNAL_NODES / 2)      /*进路中最大同时出清区段*/
...
#define SEMI_AUTO_SEND_TIME (3000u / CI_CYCLE_MS) /*半自动信号最大发送时间*/
