...
uint8_t CI_CompressSntState(uint16_t state)
{
    switch (state)
    {
		...
		case 0xAB17: return 0xC7;
		case 0xAB18: return 0xC8;
		case 0xAB19: return 0xC9;
		case 0xAB1A: return 0xCA;
		case 0xAB1B: return 0xCB;
		case 0xAB1C: return 0xCC;
		case 0xAB1D: return 0xCD;
...
uint16_t CI_DecompressSntState(uint8_t state)
{
    switch(state)
    {
		...
		case 0xC7: return 0xAB17;
		case 0xC8: return 0xAB18;
		case 0xC9: return 0xAB19;
		case 0xCA: return 0xAB1A;
		case 0xCB: return 0xAB1B;
		case 0xCC: return 0xAB1C;
		case 0xCD: return 0xAB1D;
